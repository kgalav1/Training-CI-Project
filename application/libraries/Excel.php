...
class Excel extends PHPExcel
{
	public function __construct()
	{
		...
		// $this->excel->getProperties()->setCreator("Sansoftwares")->setTitle("Harishci - Report")->setSubject("Harishci - Report - Report File")->setCategory("Report file");
		// $this->worksheet = $this->excel->getActiveSheet();
		// $this->sheetHeadingStyle = array(
		// 	'font' => array(
		// 		'bold'		=> true,
		// 		'size'		=> 14,
		// 		'wrap'		=> false,
		...
		// );
		// $this->sheetSubHeadingStyle = array(
		// 	'font' =>  array(
		// 		'bold'	=> true,
		// 		'size'	=> 11,
		// 		'wrap'	=> false,
		...
		// 	'alignment' => array('horizontal' => PHPExcel_Style_Alignment::HORIZONTAL_LEFT)
		// );
		// $this->sheetSubSubHeadingStyle = array(
		// 	'font' =>  array(
		// 		'bold'	=> true,
		// 		'size'	=> 11,
		// 		'wrap'	=> false,
	...
	public function downloadExeclData($excelName = '')
	{
        ...
        // $objWriter = new PHPExcel_Writer_Excel5($this->excel,'Excel5yg');
