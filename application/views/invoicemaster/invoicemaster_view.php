    ...
    <div class="mybox animated" style="border-radius: 10px;">
        <div class="container-fluid bg-light p-3 rounded">
            <nav>
                <div class="nav nav-tabs" id="nav-tab" role="tablist">
                    <button class="nav-link active" id="nav-home-tab" data-bs-toggle="tab" data-bs-target="#nav-home" type="button" role="tab" aria-controls="nav-home" aria-selected="true" onclick="invoicehide()">All
                        Invoice</button>
                        ...
                        <div class="mybox" style="padding: 1%; border-radius: 10px;">
                            <form class="mt-4 fw-bold">
                                <div class="mb-3 mx-3 d-inline-block" id="sinvoicenumberdiv">
                                    ...
                                    <input type="text" class="form-control" id="sinvoicenumber" name="sinvoicenumber" aria-describedby="invoicenumber" maxlength="3" oninput="this.value = this.value.replace(/[^0-9.]/g, '').replace(/(\..*)\./g, '$1');" />

                                </div>

                                <div class="mb-3 mx-3 d-inline-block" id="snamediv">
                                    <label for="name" class="form-label">Name</label>
                                    <input type="text" class="form-control" id="sname" name="sname" aria-describedby="username" maxlength="15" oninput=" this.value = this.value.replace(/[^A-za-z\s]/g, '');" />
                                </div>
                                ...
                                <div class="mt-3 d-inline-block">
                                    ...
                                    <button type="button" name="search" id="search" class="btn btn-primary" onclick="invoice_search();"><i class="fa-solid fa-magnifying-glass me-2"></i>Search</button>
                                    <button type="button" name="reset" id="reset" class="btn btn-success ms-2" onclick="clear_val('invoice')"> <i class="fa-solid fa-rotate-right me-2"></i>Reset
                                    </button>
                                </div>
                            </form>
                        </div>
                                ...
                                <thead class="tr">
                                    <tr class="trcolor">
                                        ...
                                        <th><a href="javascript:void(0);" class="asc" onclick="sort(`asc`, `invoice_id`)">
                                            ...
                                            <a href="javascript:void(0);" class="desc" onclick="sort(`desc`, `invoice_id`)" style="display: none;">Invoice Id
                                                <i class="fa fa-sort-desc" aria-hidden="true"></i></a>
                                        </th>
                                        <th><a href="javascript:void(0);" class="asc" onclick="sort(`asc`, `client_name`)">Client Name
                                                <i class="fa fa-sort-asc d-asc" aria-hidden="true" style="display: none; "></i></a>
                                            <a href="javascript:void(0);" class="desc" onclick="sort(`desc`, `client_name`)" style="display: none;">Client Name
                                                <i class="fa fa-sort-desc" aria-hidden="true"></i></a>
                                        </th>
                                        ...
                                        <th><a href="javascript:void(0);" class="asc" onclick="sort(`asc`, `grand_total`)">Total Amount
                                                <i class="fa fa-sort-asc d-asc" aria-hidden="true" style="display: none; "></i></a>
                                            <a href="javascript:void(0);" class="desc" onclick="sort(`desc`, `grand_total`)" style="display: none;">Total
                                                Amount
                                                <i class="fa fa-sort-desc" aria-hidden="true"></i></a>
                                        </th>
                                ...
                                <form id="email_send">
                                    ...
                                    <div class="modal-body">
                                        <div class="mb-3">
                                            ...
                                            <input type="email" class="form-control" id="invoice_email" name="to" placeholder="name@example.com">
                                        </div>
                                        <div class="mb-3">
                                        ...
                                        <div class="mb-3">
                                            ...
                                            <textarea class="form-control" id="invoice_body" name="body" rows="3"></textarea>
                                        </div>
                                    </div>
                            ...
                            <form class="mt-4 fw-bold" id="add_name">
                                    ...
                                    <div class="row mx-3">
                                        <div class="col-md-3 mb-1">
                                            ...
                                            <div class="input-group input-group-md ">
                                                ...
                                                <span class="input-group-text input-group-prepend input-group-md ">SAN</span>
                                                <input type="text" id="anumber" name="number" class="form-control form-control-md input-group-md" value="<?= $count[0]['max'] + 1  ?>" readonly />

                                            </div>
                                        </div>
                                        <div class="mb-3 col-md-3" id="datediv">
                                            <label for="date" class="form-label">Invoice date</label> <span class="formerror">*</span>
                                            <input type="date" class="form-control empty" id="adate" name="date" aria-describedby="emailHelp">
                                        </div>
                                    </div>
                                    <div class="row mx-3">
                                        <div class="mb-3 col-md-3" id="namediv">
                                            <label for="name" class="form-label">Client Name<span style="color: red;">*</span></label> <span class="formerror"></span>
                                            <input type="text" class="form-control empty" id="aname" name="name" onkeypress="clientsearch()" aria-describedby="emailHelp" value="" maxlength="15" autocomplete="off">
                                        </div>

                                        <div class="mb-3 col-md-3" id="emaildiv">
                                            <label for="email" class="form-label">Email</label>
                                            <input type="email" class="form-control empty" id="aemail" name="email" value="" aria-describedby="emailHelp" readonly>
                                        </div>

                                        <div class="mb-3 col-md-3" id="phonediv">
                                            <label for="phone" class="form-label">Phone No.</label>
                                            <input type="text" class="form-control empty" id="aphone" name="phone" aria-describedby="emailHelp" readonly>
                                        </div>
                                ...
                                <div class="row mt-3">
                                    ...
                                    <div class="col-md-2" id="tamountdiv">
                                        <input type="text" class="form-control empty" id="tamount" name="tamount" aria-describedby="emailHelp" dir='rtl' readonly>
                                    </div>
        ...
        <script>
            ...
            function invoiceEdit(id) {
                var invoice_id = id;
                $.ajax({
                    url: "<?= base_url() ?>Invoicemaster/editDetailsFill",
                    type: 'POST',
                    dataType: "json",
                    async: "false",
                    mode: "abort",
            ...
            $('#add_name').on('submit', function(event) {
                ...
                if (valueitem == true) {
                    $.ajax({
                        url: "<?= base_url() ?>Invoicemaster/addUpdate",
                        type: "POST",
                        data: data,
                        contentType: false,
                        cache: false,
            ...
            function clientsearch() {
                $('#aname').autocomplete({
                    source: function(request, response) {
                        $.ajax({
                            url: "<?= base_url() ?>Invoicemaster/clientAutofill",
                            type: 'POST',
                            dataType: "json",
                            async: "false",
                            mode: "abort",
                            ...
                            success: function(returnObj) {
                                response($.map(returnObj.data, function(client, input) {
            ...
            function itemsearch() {
                $('.itemname').autocomplete({
                    source: function(request, response) {
                        $.ajax({
                            url: "<?= base_url() ?>Invoicemaster/itemAutofill",
                            type: 'POST',
                            dataType: "json",
                            async: "false",
                            mode: "abort",
                            ...
                            beforeSend: function() {},
                            success: function(responce) {
                                response($.map(responce.data, function(item, input) {
            ...
            function sendMail() {
                ...
                $.ajax({
                    type: "POST",
                    url: "<?= base_url() ?>Invoicemaster/sendMail",
                    data: {
                        id: id,
                        to: to,
                        subject: subject,
