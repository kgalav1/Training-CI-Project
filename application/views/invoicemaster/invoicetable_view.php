...
<tr>
        ...
        <td><button type='button' class='bremove'><img style='width:24px' src='<?= base_url() ?>assets/images/file.png' alt='pdf' onclick="Getpdf('<?=$row->invoice_id?>','<?=base_url('InvoicePDF')?>')"></button></td>
