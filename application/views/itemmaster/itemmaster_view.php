    ...
    <div class="mybox" style="border-radius: 10px;">
        <div class="container-fluid bg-light p-3 rounded">
            ...
            <div class="tab-content" id="nav-tabContent">
                        ...
                        <div class="mybox" style="padding: 1%; border-radius: 10px;">
                            <form class="mt-4 fw-bold">
                                ...
                                <div class="mb-4 mx-3 d-inline-block">
                                    ...
                                    <button type="button" name="searchbtn" id="searchbtn" class="btn btn-primary" onclick="item_search()"><i class="fa-solid fa-magnifying-glass me-2"></i>Search</button>
                                    <button type="button" name="reset" id="reset" class="btn btn-success ms-2" onclick="clear_val('item')"> <i class="fa-solid fa-rotate-right me-2"></i>Reset
                                    </button>
                                </div>
                            </form>
                        </div>
                                    ...
                                    <thead class="tr">
                                        <tr class="table-primary">
                                            ...
                                            <th><a href="javascript:void(0);" class="asc" onclick="sort(`asc`, `name`)">
                                                    Item Name<i class="fa fa-sort-asc d-asc" aria-hidden="true" style="display: none; "></i></a>
                                                <a href="javascript:void(0);" class="desc" onclick="sort(`desc`, `name`)" style="display: none;">Item Name
                                                    <i class="fa fa-sort-desc" aria-hidden="true"></i></a>
                                            </th>
                                            <th><a href="javascript:void(0);" class="asc" onclick="sort(`asc`, `desc`)">Description
                                                    <i class="fa fa-sort-asc d-asc" aria-hidden="true" style="display: none; "></i></a>
                                                <a href="javascript:void(0);" class="desc" onclick="sort(`desc`, `desc`)" style="display: none;">Description
                                                    <i class="fa fa-sort-desc" aria-hidden="true"></i></a>
                                            </th>
                                            <th><a href="javascript:void(0);" class="asc" onclick="sort(`asc`, `price`)">Price
                                                    <i class="fa fa-sort-asc d-asc" aria-hidden="true" style="display: none; "></i></a>
                                                <a href="javascript:void(0);" class="desc" onclick="sort(`desc`, `price`)" style="display: none;">Price
                                                    <i class="fa fa-sort-desc" aria-hidden="true"></i></a>
                                            </th>
                                            <th>Image</th>
                                            <th>Action</th>
                ...
                <div class="tab-pane fade" id="nav-profile" role="tabpanel" aria-labelledby="nav-profile-tab" style="height: 12rem;">

                    <div class="form mt-3 position-relative" id="addblock">
                        <div class="mybox" style="padding: 1%; border-radius: 10px;">
                            <form enctype="multipart/form-data" onsubmit="return validateItem()" class="mt-4 fw-bold" id="itemmaster">
                                <input type="hidden" class="snoEdit" name="snoEdit" id="snoEdit">
                                <div class="mx-3 d-inline-block" id="namediv">
                                    <label for="name" class="form-label">Item Name<span style="color: red;">*</span></label>
                                    <span class="formerror"></span>
                                    <input type="text" class="form-control" id="aname" name="name" aria-describedby="emailHelp" maxlength="15" oninput=" this.value = this.value.replace(/[^A-za-z\s]/g, '');">
                                </div>

                                <div class="mx-3 d-inline-block" id="descdiv">
                                    <label for="desc" class="form-label">Item Description<span style="color: red;">*</span></label> <span class="formerror"></span>
                                    <input type="text" class="form-control" id="adesc" name="desc" aria-describedby="emailHelp" maxlength="70">
                                </div>

                                <div class="mx-3 d-inline-block" id="pricediv">
                                    <label for="price" class="form-label">Item Price<span style="color: red;">*</span></label>
                                    <span class="formerror"></span>
                                    <input type="text" class="form-control" id="aprice" name="price" aria-describedby="emailHelp" maxlength="10" oninput="this.value = this.value.replace(/[^0-9.]/g, '').replace(/(\..*)\./g, '$1');" />
                                </div>

                                <div class="mx-3 d-inline-block" id="filediv">
                                    <label for="file" class="form-label">Choose File<span style="color: red;">*</span></label>
                                    <span class="formerror"></span>
                                    <input type="file" class="form-control" style="width:270px;" id="afile" name="file" aria-describedby="emailHelp" onchange="ImageShowInImageTag(this,preview);">
                                ...
                                <div class="preview" id="imagediv"><img id="preview" style="display: none;" class="imageitem" src="" alt="preview"></div>
                            </form>
                        </div>
                    </div>
                </div>
    ...
    <script>
        ...
        $('#itemmaster').on('submit', function(event) {
            ...
            if (valueitem == true) {
                ...
                $.ajax({
                    url: "<?= base_url() ?>Itemmaster/addUpdate",
                    method: "POST",
                    data: data,
                    contentType: false,
                    cache: false,
        ...
        function itemEdit(id) {
            var edit_id = id;
            $.ajax({
                url: "<?= base_url() ?>Itemmaster/editDetailsFill",
                type: 'POST',
                dataType: "json",
                async: "false",
                mode: "abort",
                ...
                success: function(responce) {
                    ...
                    $('#adesc').val(responce.desc);
                    $('#aprice').val(responce.price);
                    $('#path').val(responce.image);
                    $("#preview").css({
                        "display": "block"
                    });
                    // $('#imagediv').html('');
            ...
            $.confirm({
                ...
                buttons: {
                    tryAgain: {
                        ...
                        action: function() {
                            $.ajax({
                                url: "<?= base_url() ?>Itemmaster/deleteItem",
                                type: 'POST',
                                dataType: "json",
                                async: "false",
                                mode: "abort",
